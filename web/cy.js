function cy(str) {
    ...
    resultElement.innerHTML += "第一组数字: <b class='content'>" + number1s.join(" + ") + "</b><br/>";
    resultElement.innerHTML += "</b>\n数据个数: <b class='content'>" + num1Count + "</b>, 总和: <b class='content'>" + dealNumber(num1Sum) + "</b><br/>";
    resultElement.innerHTML += "第二组数字: <b class='content'>" + number2s.join(" + ") + "</b><br/>";
    resultElement.innerHTML += "</b>\n数据个数: <b class='content'>" + num2Count + "</b>, 总和: <b class='content'>" + dealNumber(num2Sum) + "</b><br/>";
    resultElement.innerHTML += "第一组数的平均数：<b class='content'>" + avgNum1 + "</b><br/>";
    resultElement.innerHTML += "第二组数的平均数：<b class='content'>" + avgNum2 + "</b><br/>";
    resultElement.innerHTML += "已拷贝到粘贴板：<b class='content'>" + avgNum1 + "/" + avgNum2 + "</b><br/>";
    console.log("第一组数字: " + number1s.join(" + ") + "\t\t, 数据个数: " + num1Count + ", 总和: " + num1Sum);
    console.log("第二组数字: " + number2s.join(" + ") + "\t\t, 数据个数: " + num2Count + ", 总和: " + num2Sum);
    console.log("第一组数的平均数：" + avgNum1);
    console.log("第二组数的平均数：" + avgNum2);
